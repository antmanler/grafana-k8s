...
: ${ELASTICSEARCH_SERVICE_PORT:=127.0.0.1}
...
sed -i \
    ...
    -e "s/<--ES-ADDR-->/${ELASTICSEARCH_SERVICE_HOST}/g" \
    -e "s/<--ES-PORT-->/${ELASTICSEARCH_SERVICE_PORT}/g" \
...
echo "   Elasticseach ADDRESS:  ${ELASTICSEARCH_SERVICE_HOST}"
echo "   Elasticseach PORT:     ${ELASTICSEARCH_SERVICE_PORT}"
